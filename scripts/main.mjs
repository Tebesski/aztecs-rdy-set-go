...
Hooks.once("ready", async () => {
   ...
   overlay.setResumeHandler(resumeOpportunity)
   overlay.setStopActingHandler(stopActing)
   ...
   const api = {
      ...
      triggerWithCountdown: (seconds, opts = {}) =>
         broadcastOpportunity({ initialCountdownSeconds: seconds, ...opts }),
      snatch: () => snatch(),
      ...
      closeCountdownPicker: () => closeCountdownPicker(),
   }
